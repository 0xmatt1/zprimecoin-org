...
if [[ "$OSTYPE" == "darwin"* ]]; then
    PARAMS_DIR="$HOME/Library/Application Support/zPrimeParams"
else
    PARAMS_DIR="$HOME/.zprime-params"
fi
...
Failed to fetch the zPrime zkSNARK parameters!
...
function main() {
    ...
    cat <<EOF
zPrime - fetch-params.sh

This script will fetch the zPrime zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common zPrime zkSNARK parameters. Note that it is
