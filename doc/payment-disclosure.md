...
This is an experimental feature.  Enable it by launching `zprimed` with flags:

    zprimed -experimentalfeatures -paymentdisclosure -debug=paymentdisclosure -txindex=1

These flags can also be set as options in `zprime.conf`.
...
[1] https://github.com/zprimecoin/zips/pull/119
...
Generate a payment disclosure for the first joinsplit, second output (index starts from zero):
    ...
    zprime-cli z_getpaymentdisclosure 79189528d611e811a1c7bb0358dd31343033d14b4c1e998d7c4799c40f8b652b 0 1 "Hello"
...
To validate the payment disclosure:
    ...
    zprime-cli z_validatepaymentdisclosure HEXDATA
