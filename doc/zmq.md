...
router", implementing the zPrime wire protocol and relay, making
...
The ZeroMQ feature in zPrime requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ zprimed -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/zprimed.tx.raw
...
From the perspective of zprimed, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into zprimed directly. Furthermore, no information is
...
using. zPrimed appends an up-counting sequence number to each
