...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to zprimed by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for zprimed -help.
...
Jay Graber (5):
      ...
      Add security warning to zprime-cli --help and --version message output
      Add security warning to zprimed metrics display
