...
ECDSA signatures inside zPrime transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to zPrime.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in zprime-gtest
...
kozyilmaz (3):
      ...
      option to disable building libraries (zputil/build.sh)
