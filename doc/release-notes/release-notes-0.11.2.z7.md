...
bitcartel (15):
      ...
      Update URL for zprime alert IDs.
...
Taylor Hornby (17):
      ...
      Rename zerocash to zprime in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/zprime in Makefile.am
      Rename zerocash_packages to zprime_packages in packages.mk
