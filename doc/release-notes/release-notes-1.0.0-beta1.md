...
Lars-Magnus Skog (1):
      changed module name from "bitcoin" to "zPrime" in FormatException()
...
Simon (91):
      ...
      Reduce use of global pzprimeParams with private member variable
      Revert "Reduce use of global pzprimeParams with private member variable"
      Replace zprimeParams_ with global.
