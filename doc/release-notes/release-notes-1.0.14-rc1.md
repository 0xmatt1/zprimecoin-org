...
[the zPrime protocol spec](https://github.com/zprimecoin/zips/blob/master/protocol/protocol.pdf),
...
- **Caution:** for z-addresses, these balances will **not** be accurate if any
  ...
  (e.g. [#2542](https://github.com/zprimecoin/zprime/issues/2542)).
...
Jack Grigg (36):
      ...
      build: Split hardening/fPIE options out in zPrime-specific binaries
      Change --enable-werror to apply to all warnings, use it in build.sh
      Move zPrime flags into configure.ac
      ViewingKey -> ReceivingKey per zprime/zips#117
      ...
      Add watch-only support to zPrime RPC methods
...
syd (13):
      ...
      Rename bash completion files so that they refer to zprime and not bitcoin.
