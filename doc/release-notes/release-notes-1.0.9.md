...
Jack Grigg (14):
      ...
      Convert zPrime versions to Debian format
      ...
      Implement automatic shutdown of deprecated zPrime versions
...
Jay Graber (2):
      Change help text examples to use zPrime addresses
...
Nathan Wilcox (39):
      ...
      Add all of the zprime release tags in my current repo as positive test vector.
      ...
      Reuse zprime_rpc.
      Do not use `-rpcwait` on all `zprime_rpc` invocations, only block when starting zprimed.
