...
------------------------------------------
We include a fix for a bug in the zPrimed wallet which could result in Sprout
...
“zprimed -rescan”. Sprout address balances shown by the zprimed wallet should
then be correct.
...
[Pull request](https://github.com/zprimecoin/zprime/pull/3897)

Miner address selection behaviour fixed
---------------------------------------
zPrime inherited a bug from upstream Bitcoin Core where both the internal miner
...
[Mining Guide](https://zprime.readthedocs.io/en/latest/rtd_pages/zprime_mining_guide.html)
...
[ZIP draft](https://github.com/zprimecoin/zips/pull/210).

The consensus rule will be enforced on mainnet in a future release.

[Pull request](https://github.com/zprimecoin/zprime/pull/3885)
