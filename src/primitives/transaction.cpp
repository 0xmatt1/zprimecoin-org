...
{
    std::array<libzprime::SproutNote, ZC_NUM_JS_OUTPUTS> notes;
...
public:
    ...
    bool operator()(const libzprime::PHGRProof& proof) const
    {
    ...
    bool operator()(const libzprime::GrothProof& proof) const
    {
