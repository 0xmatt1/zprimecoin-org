/*
See the zPrime protocol specification for more information.
https://github.com/zprimecoin/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libzprime::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libzprime::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;

typedef libzprime::PaymentDisclosureNoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCPaymentDisclosureNoteDecryption;
