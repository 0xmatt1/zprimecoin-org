...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your zprime.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    RenameThread("zprime-metrics-screen");
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a zPrime node!") << std::endl;
    ...
    while (true) {
        ...
        if (isScreen) {
            ...
            std::cout << "[";
#ifdef WIN32
            std::cout << _("'zprime-cli.exe stop' to exit");
#else
