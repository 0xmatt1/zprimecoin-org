...
bool ShieldToAddress::operator()(const libzprime::SproutPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libzprime::SaplingPaymentAddress &zaddr) const {
...
bool ShieldToAddress::operator()(const libzprime::InvalidEncoding& no) const {
    return false;
}
