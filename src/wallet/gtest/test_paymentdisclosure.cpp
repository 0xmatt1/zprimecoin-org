...
/*
    To run tests:
    ./zprime-gtest --gtest_filter="paymentdisclosure.*"
...
TEST(paymentdisclosure, mainnet) {
    ...
    for (int i=0; i<NUM_TRIES; i++) {
        ...
        info.zaddr = libzprime::SproutSpendingKey::random().address();
        ...
        info2.zaddr = libzprime::SproutSpendingKey::random().address();
