...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new zPrime address for receiving payments.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. If provided, it MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "\nResult:\n"
            "\"zprimeaddress\"    (string) The new zPrime address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current zPrime address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "\nResult:\n"
            "\"zprimeaddress\"   (string) The account zPrime address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new zPrime address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"zprimeaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"zprimeaddress\"  (string, required) The zPrime address to be associated with an account.\n"
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid zPrime address");
    }
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"zprimeaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"zprimeaddress\"  (string, required) The zPrime address for account lookup.\n"
            "\nResult:\n"
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"zprimeaddress\"  (string) a zPrime address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "sendtoaddress \"zprimeaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"zprimeaddress\"  (string, required) The zPrime address to send to.\n"
            ...
            "                             The recipient will receive less zPrime than you enter in the amount field.\n"
            "\nResult:\n"
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"zprimeaddress\",     (string) The zprime address\n"
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"zprimeaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given zPrime address in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"zprimeaddress\"  (string, required) The zPrime address for transactions.\n"
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tozprimeaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a zPrime address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"
            "2. \"tozprimeaddress\"  (string, required) The zPrime address to send funds to.\n"
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The zPrime address is the key, the numeric amount in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less zPrime than you enter in their corresponding amount field.\n"
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid zPrime address: ") + name_);
        }
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a zPrime address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of zPrime addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) zPrime address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. If provided, MUST be set to the empty string \"\" to represent the default account. Passing any other string will result in an error.\n"

            "\nResult:\n"
            "\"zprimeaddress\"  (string) A zPrime address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"zprimeaddress\",    (string) The zPrime address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"zprimeaddress\",    (string) The zPrime address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"zprimeaddress\",   (string) The zPrime address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending zPrime\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending zPrime\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"zprimeaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; zPrime server stopping, restart to run with encrypted wallet. The keypool has been flushed, you need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending zPrime.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of zPrime addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) zPrime address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"address\" : \"address\",    (string) the zPrime address\n"
    ...
    if (params.size() > 2) {
        ...
        for (size_t idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid zPrime address: ") + input.get_str());
            }
...
UniValue z_listunspent(const UniValue& params, bool fHelp)
{
    ...
    std::set<libzprime::PaymentAddress> zaddrs = {};
    ...
    if (params.size() > 3) {
        ...
        std::set<libzprime::SproutPaymentAddress> sproutzaddrs = {};
        pwalletMain->GetSproutPaymentAddresses(sproutzaddrs);

        // Sapling support
        std::set<libzprime::SaplingPaymentAddress> saplingzaddrs = {};
    ...
    if (zaddrs.size() > 0) {
        ...
        for (auto & entry : sproutEntries) {
            ...
            bool hasSproutSpendingKey = pwalletMain->HaveSproutSpendingKey(boost::get<libzprime::SproutPaymentAddress>(entry.address));
        ...
        for (auto & entry : saplingEntries) {
            ...
            pwalletMain->GetSaplingIncomingViewingKey(boost::get<libzprime::SaplingPaymentAddress>(entry.address), ivk);
...
UniValue zc_raw_receive(const UniValue& params, bool fHelp)
{
    ...
    if (boost::get<libzprime::SproutSpendingKey>(&spendingkey) == nullptr) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Only works with Sprout spending keys");
    }
    SproutSpendingKey k = boost::get<libzprime::SproutSpendingKey>(spendingkey);
...
UniValue zc_raw_joinsplit(const UniValue& params, bool fHelp)
{
    ...
    for (const string& name_ : outputs.getKeys()) {
        ...
        if (boost::get<libzprime::SproutPaymentAddress>(&addrTo) == nullptr) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Only works with Sprout payment addresses");
        }
        CAmount nAmount = AmountFromValue(outputs[name_]);

        vjsout.push_back(JSOutput(boost::get<libzprime::SproutPaymentAddress>(addrTo), nAmount));
    }
    ...
    std::string encryptedNote2;
    {
        ...
        ss2 << jsdesc.h_sig(*pzprimeParams, joinSplitPubKey);
...
UniValue z_getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"zprimeaddress\"    (string) The new shielded address.\n"
            "\nExamples:\n"
...
UniValue z_listaddresses(const UniValue& params, bool fHelp)
{
    ...
    UniValue ret(UniValue::VARR);
    {
        std::set<libzprime::SproutPaymentAddress> addresses;
    ...
    {
        std::set<libzprime::SaplingPaymentAddress> addresses;
...
UniValue z_listreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (boost::get<libzprime::SproutPaymentAddress>(&zaddr) != nullptr) {
    ...
    } else if (boost::get<libzprime::SaplingPaymentAddress>(&zaddr) != nullptr) {
...
UniValue z_sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (!fromTaddr) {
        ...
        fromSapling = boost::get<libzprime::SaplingPaymentAddress>(&res) != nullptr;
    }
    ...
    for (const UniValue& o : outputs.getValues()) {
        ...
        if (!IsValidDestination(taddr)) {
            ...
            if (IsValidPaymentAddress(res)) {
                ...
                bool toSapling = boost::get<libzprime::SaplingPaymentAddress>(&res) != nullptr;
...
UniValue z_mergetoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (!fEnableMergeToAddress) {
        throw JSONRPCError(RPC_WALLET_ERROR, "Error: z_mergetoaddress is disabled. Run './zprime-cli help z_mergetoaddress' for instructions on how to enable this feature.");
    }
    ...
    if (!IsValidDestination(taddr)) {
        ...
        if (IsValidPaymentAddress(decodeAddr)) {
            if (boost::get<libzprime::SaplingPaymentAddress>(&decodeAddr) != nullptr) {
        ...
        for (const SaplingNoteEntry& entry : saplingEntries) {
            ...
            if (!maxedOutNotesFlag) {
                    ...
                    (saplingNoteLimit > 0 && noteCounter > saplingNoteLimit))
                {
                    ...
                    estimatedTxSize += increase;
                    libzprime::SaplingExtendedSpendingKey extsk;
