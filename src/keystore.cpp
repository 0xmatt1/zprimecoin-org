...
bool CBasicKeyStore::AddSproutSpendingKey(const libzprime::SproutSpendingKey &sk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::AddSproutViewingKey(const libzprime::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::RemoveSproutViewingKey(const libzprime::SproutViewingKey &vk)
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::HaveSproutViewingKey(const libzprime::SproutPaymentAddress &address) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSproutViewingKeys.count(address) > 0;
}

bool CBasicKeyStore::HaveSaplingFullViewingKey(const libzprime::SaplingIncomingViewingKey &ivk) const
{
    LOCK(cs_SpendingKeyStore);
    return mapSaplingFullViewingKeys.count(ivk) > 0;
}

bool CBasicKeyStore::HaveSaplingIncomingViewingKey(const libzprime::SaplingPaymentAddress &addr) const
{
    LOCK(cs_SpendingKeyStore);
...
bool CBasicKeyStore::GetSaplingFullViewingKey(const libzprime::SaplingIncomingViewingKey &ivk,
...
bool CBasicKeyStore::GetSaplingIncomingViewingKey(const libzprime::SaplingPaymentAddress &addr,
...
bool CBasicKeyStore::GetSaplingExtendedSpendingKey(const libzprime::SaplingPaymentAddress &addr,
