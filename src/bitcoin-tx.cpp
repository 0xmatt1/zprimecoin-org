...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("zPrime zprime-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  zprime-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zprime transaction") + "\n" +
              "  zprime-tx [options] -create [commands]   " + _("Create hex-encoded zprime transaction") + "\n" +
              "\n";
