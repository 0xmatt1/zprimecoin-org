...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("zPrime RPC client version") + " " + FormatFullVersion() + "\n" + PrivacyInfo();
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  zprime-cli [options] <command> [params]  " + _("Send command to zPrime") + "\n" +
                  "  zprime-cli [options] help                " + _("List commands") + "\n" +
                  "  zprime-cli [options] help <command>      " + _("Get help for a command") + "\n";
